    ...
    return(
        ...
        <div className={styles.reactform}>
            ...
            <div className={styles.introduce}>
                ...
                번호를 버튼으로 만들어 숫자 리스트에 추가 제거를 할 수 있게 했습니다.<br />
                추가 버튼을 눌렷을때는 검은 색으로 바뀌면서 해당 번호를 숫자 리스트에 포함시키고
                제거 버튼을 눌렷을때 붉은 색으로 변하며 해당 번호를 숫자 리스트에서 제거합니다.<br />
                리셋 버튼을 추가해 추가 및 제거를 지정해둔 번호들을 초기화 시킬 수 있게 만들었고
